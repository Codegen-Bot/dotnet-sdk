...
, TextAndCarets = textAndCarets
    ...
    var response = Imports.GraphQL(request, GraphQLOperationsJsonSerializerContext.Default.GraphQLRequestAddFileVariables);
    var result = JsonSerializer.Deserialize<GraphQLResponse<AddFileData>>(response, GraphQLOperationsJsonSerializerContext.Default.GraphQLResponseAddFileData);
...
, TextAndCarets = textAndCarets
    ...
    var response = Imports.GraphQL(request, GraphQLOperationsJsonSerializerContext.Default.GraphQLRequestAddKeyedTextVariables);
    var result = JsonSerializer.Deserialize<GraphQLResponse<AddKeyedTextData>>(response, GraphQLOperationsJsonSerializerContext.Default.GraphQLResponseAddKeyedTextData);
...
, TextAndCarets = textAndCarets
    ...
    var response = Imports.GraphQL(request, GraphQLOperationsJsonSerializerContext.Default.GraphQLRequestAddKeyedTextByTagsVariables);
    var result = JsonSerializer.Deserialize<GraphQLResponse<AddKeyedTextByTagsData>>(response, GraphQLOperationsJsonSerializerContext.Default.GraphQLResponseAddKeyedTextByTagsData);
...
, TextAndCarets = textAndCarets
    ...
    var response = Imports.GraphQL(request, GraphQLOperationsJsonSerializerContext.Default.GraphQLRequestAddTextVariables);
    var result = JsonSerializer.Deserialize<GraphQLResponse<AddTextData>>(response, GraphQLOperationsJsonSerializerContext.Default.GraphQLResponseAddTextData);
...
, TextAndCarets = textAndCarets
    ...
    var response = Imports.GraphQL(request, GraphQLOperationsJsonSerializerContext.Default.GraphQLRequestAddTextByTagsVariables);
    var result = JsonSerializer.Deserialize<GraphQLResponse<AddTextByTagsData>>(response, GraphQLOperationsJsonSerializerContext.Default.GraphQLResponseAddTextByTagsData);
...
}public static GetConfigurationData GetConfiguration()
{
    ...
    var response = Imports.GraphQL(request, GraphQLOperationsJsonSerializerContext.Default.GraphQLRequestGetConfigurationVariables);
    var result = JsonSerializer.Deserialize<GraphQLResponse<GetConfigurationData>>(response, GraphQLOperationsJsonSerializerContext.Default.GraphQLResponseGetConfigurationData);
...
, Blacklist = blacklist
    ...
    var response = Imports.GraphQL(request, GraphQLOperationsJsonSerializerContext.Default.GraphQLRequestGetFilesVariables);
    var result = JsonSerializer.Deserialize<GraphQLResponse<GetFilesData>>(response, GraphQLOperationsJsonSerializerContext.Default.GraphQLResponseGetFilesData);
...
}public static GetSchemaData GetSchema(string botFilePath)
{
    ...
    var response = Imports.GraphQL(request, GraphQLOperationsJsonSerializerContext.Default.GraphQLRequestGetSchemaVariables);
    var result = JsonSerializer.Deserialize<GraphQLResponse<GetSchemaData>>(response, GraphQLOperationsJsonSerializerContext.Default.GraphQLResponseGetSchemaData);
...
, Arguments = arguments
    ...
    var response = Imports.GraphQL(request, GraphQLOperationsJsonSerializerContext.Default.GraphQLRequestLogVariables);
    var result = JsonSerializer.Deserialize<GraphQLResponse<LogData>>(response, GraphQLOperationsJsonSerializerContext.Default.GraphQLResponseLogData);
...
}public static ParseGraphQLSchemaData ParseGraphQLSchema(string graphql)
{
    var request = new GraphQLRequest<ParseGraphQLSchemaVariables>
    {
        ...
        Variables = new ParseGraphQLSchemaVariables()
        {
            Graphql = graphql
    ...
    var response = Imports.GraphQL(request, GraphQLOperationsJsonSerializerContext.Default.GraphQLRequestParseGraphQLSchemaVariables);
    var result = JsonSerializer.Deserialize<GraphQLResponse<ParseGraphQLSchemaData>>(response, GraphQLOperationsJsonSerializerContext.Default.GraphQLResponseParseGraphQLSchemaData);
    return result?.Data ?? throw new InvalidOperationException("Received null data for request ParseGraphQLSchema.");
}public static ParseGraphQLSchemaAndOperationsData ParseGraphQLSchemaAndOperations(List<AdditionalFileInput>? graphql)
{
    ...
    var response = Imports.GraphQL(request, GraphQLOperationsJsonSerializerContext.Default.GraphQLRequestParseGraphQLSchemaAndOperationsVariables);
    var result = JsonSerializer.Deserialize<GraphQLResponse<ParseGraphQLSchemaAndOperationsData>>(response, GraphQLOperationsJsonSerializerContext.Default.GraphQLResponseParseGraphQLSchemaAndOperationsData);
...
}public static ReadTextFileData ReadTextFile(string textFilePath)
{
    ...
    var response = Imports.GraphQL(request, GraphQLOperationsJsonSerializerContext.Default.GraphQLRequestReadTextFileVariables);
    var result = JsonSerializer.Deserialize<GraphQLResponse<ReadTextFileData>>(response, GraphQLOperationsJsonSerializerContext.Default.GraphQLResponseReadTextFileData);
...
, FileVersion = fileVersion
    ...
    var response = Imports.GraphQL(request, GraphQLOperationsJsonSerializerContext.Default.GraphQLRequestReadTextFileWithVersionVariables);
    var result = JsonSerializer.Deserialize<GraphQLResponse<ReadTextFileWithVersionData>>(response, GraphQLOperationsJsonSerializerContext.Default.GraphQLResponseReadTextFileWithVersionData);
