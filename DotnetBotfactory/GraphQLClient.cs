...
[JsonSerializable(typeof(ParseGraphQLSchemaAndOperationsFragmentDenestedSelectionItemFieldSelection))]
[JsonSerializable(typeof(ParseGraphQLSchemaAndOperationsFragmentDenestedSelectionItemFragmentSpreadSelection))]
[JsonSerializable(typeof(ParseGraphQLSchemaAndOperationsFragmentDenestedSelectionItemInlineFragmentSelection))]
...
[JsonSerializable(typeof(ParseGraphQLSchemaAndOperationsOperationDenestedSelectionItemFieldSelection))]
[JsonSerializable(typeof(ParseGraphQLSchemaAndOperationsOperationDenestedSelectionItemFragmentSpreadSelection))]
[JsonSerializable(typeof(ParseGraphQLSchemaAndOperationsOperationDenestedSelectionItemInlineFragmentSelection))]
...
, TextAndCarets = textAndCarets
    ...
    var response = Imports.GraphQL(request, GraphQLClientJsonSerializerContext.Default.GraphQLRequestAddFileVariables);
    var result = JsonSerializer.Deserialize<GraphQLResponse<AddFileData>>(response, GraphQLClientJsonSerializerContext.Default.GraphQLResponseAddFileData);
    return result?.Data ?? throw new InvalidOperationException("Received null data for request AddFile.");
...
, TextAndCarets = textAndCarets
    ...
    var response = Imports.GraphQL(request, GraphQLClientJsonSerializerContext.Default.GraphQLRequestAddKeyedTextVariables);
    var result = JsonSerializer.Deserialize<GraphQLResponse<AddKeyedTextData>>(response, GraphQLClientJsonSerializerContext.Default.GraphQLResponseAddKeyedTextData);
    return result?.Data ?? throw new InvalidOperationException("Received null data for request AddKeyedText.");
}public static AddKeyedTextByTagsData AddKeyedTextByTags(string key, List<CaretTagInput> tags, string textAndCarets)
{
...
, TextAndCarets = textAndCarets
    ...
    var response = Imports.GraphQL(request, GraphQLClientJsonSerializerContext.Default.GraphQLRequestAddKeyedTextByTagsVariables);
    var result = JsonSerializer.Deserialize<GraphQLResponse<AddKeyedTextByTagsData>>(response, GraphQLClientJsonSerializerContext.Default.GraphQLResponseAddKeyedTextByTagsData);
    return result?.Data ?? throw new InvalidOperationException("Received null data for request AddKeyedTextByTags.");
}public static AddTextData AddText(string caretId, string textAndCarets)
{
    var request = new GraphQLRequest<AddTextVariables>
    {
        ...
        Variables = new AddTextVariables()
        {
            CaretId = caretId
, TextAndCarets = textAndCarets
    ...
    var response = Imports.GraphQL(request, GraphQLClientJsonSerializerContext.Default.GraphQLRequestAddTextVariables);
    var result = JsonSerializer.Deserialize<GraphQLResponse<AddTextData>>(response, GraphQLClientJsonSerializerContext.Default.GraphQLResponseAddTextData);
    return result?.Data ?? throw new InvalidOperationException("Received null data for request AddText.");
}public static AddTextByTagsData AddTextByTags(List<CaretTagInput> tags, string textAndCarets)
{
    var request = new GraphQLRequest<AddTextByTagsVariables>
    {
        ...
        Variables = new AddTextByTagsVariables()
        {
            Tags = tags
, TextAndCarets = textAndCarets
    ...
    var response = Imports.GraphQL(request, GraphQLClientJsonSerializerContext.Default.GraphQLRequestAddTextByTagsVariables);
    var result = JsonSerializer.Deserialize<GraphQLResponse<AddTextByTagsData>>(response, GraphQLClientJsonSerializerContext.Default.GraphQLResponseAddTextByTagsData);
    return result?.Data ?? throw new InvalidOperationException("Received null data for request AddTextByTags.");
}public static GetCaretData GetCaret(string caretId)
{
    var request = new GraphQLRequest<GetCaretVariables>
    {
        ...
        Variables = new GetCaretVariables()
        {
            CaretId = caretId
    ...
    var response = Imports.GraphQL(request, GraphQLClientJsonSerializerContext.Default.GraphQLRequestGetCaretVariables);
    var result = JsonSerializer.Deserialize<GraphQLResponse<GetCaretData>>(response, GraphQLClientJsonSerializerContext.Default.GraphQLResponseGetCaretData);
    return result?.Data ?? throw new InvalidOperationException("Received null data for request GetCaret.");
}public static GetConfigurationData GetConfiguration()
{
    ...
    var response = Imports.GraphQL(request, GraphQLClientJsonSerializerContext.Default.GraphQLRequestGetConfigurationVariables);
    var result = JsonSerializer.Deserialize<GraphQLResponse<GetConfigurationData>>(response, GraphQLClientJsonSerializerContext.Default.GraphQLResponseGetConfigurationData);
    return result?.Data ?? throw new InvalidOperationException("Received null data for request GetConfiguration.");
}public static GetFilesData GetFiles(List<string> whitelist, List<string> blacklist)
{
    var request = new GraphQLRequest<GetFilesVariables>
    {
        ...
        Variables = new GetFilesVariables()
        {
            Whitelist = whitelist
, Blacklist = blacklist
    ...
    var response = Imports.GraphQL(request, GraphQLClientJsonSerializerContext.Default.GraphQLRequestGetFilesVariables);
    var result = JsonSerializer.Deserialize<GraphQLResponse<GetFilesData>>(response, GraphQLClientJsonSerializerContext.Default.GraphQLResponseGetFilesData);
    return result?.Data ?? throw new InvalidOperationException("Received null data for request GetFiles.");
}public static GetSchemaData GetSchema(string botFilePath)
{
    var request = new GraphQLRequest<GetSchemaVariables>
    {
        ...
        Variables = new GetSchemaVariables()
        {
    ...
    var response = Imports.GraphQL(request, GraphQLClientJsonSerializerContext.Default.GraphQLRequestGetSchemaVariables);
    var result = JsonSerializer.Deserialize<GraphQLResponse<GetSchemaData>>(response, GraphQLClientJsonSerializerContext.Default.GraphQLResponseGetSchemaData);
    return result?.Data ?? throw new InvalidOperationException("Received null data for request GetSchema.");
...
, Arguments = arguments
    ...
    var response = Imports.GraphQL(request, GraphQLClientJsonSerializerContext.Default.GraphQLRequestLogVariables);
    var result = JsonSerializer.Deserialize<GraphQLResponse<LogData>>(response, GraphQLClientJsonSerializerContext.Default.GraphQLResponseLogData);
    return result?.Data ?? throw new InvalidOperationException("Received null data for request Log.");
}public static ParseGraphQLSchemaAndOperationsData ParseGraphQLSchemaAndOperations(List<AdditionalFileInput> graphql)
{
    var request = new GraphQLRequest<ParseGraphQLSchemaAndOperationsVariables>
    {
        ...
        Variables = new ParseGraphQLSchemaAndOperationsVariables()
        {
            Graphql = graphql
    ...
    var response = Imports.GraphQL(request, GraphQLClientJsonSerializerContext.Default.GraphQLRequestParseGraphQLSchemaAndOperationsVariables);
    var result = JsonSerializer.Deserialize<GraphQLResponse<ParseGraphQLSchemaAndOperationsData>>(response, GraphQLClientJsonSerializerContext.Default.GraphQLResponseParseGraphQLSchemaAndOperationsData);
    return result?.Data ?? throw new InvalidOperationException("Received null data for request ParseGraphQLSchemaAndOperations.");
}public static ReadTextFileData ReadTextFile(string textFilePath)
{
    var request = new GraphQLRequest<ReadTextFileVariables>
    {
        ...
        Variables = new ReadTextFileVariables()
        {
    ...
    var response = Imports.GraphQL(request, GraphQLClientJsonSerializerContext.Default.GraphQLRequestReadTextFileVariables);
    var result = JsonSerializer.Deserialize<GraphQLResponse<ReadTextFileData>>(response, GraphQLClientJsonSerializerContext.Default.GraphQLResponseReadTextFileData);
    return result?.Data ?? throw new InvalidOperationException("Received null data for request ReadTextFile.");
}public static ReadTextFileWithVersionData ReadTextFileWithVersion(string textFilePath, FileVersion? fileVersion)
{
...
, FileVersion = fileVersion
    ...
    var response = Imports.GraphQL(request, GraphQLClientJsonSerializerContext.Default.GraphQLRequestReadTextFileWithVersionVariables);
    var result = JsonSerializer.Deserialize<GraphQLResponse<ReadTextFileWithVersionData>>(response, GraphQLClientJsonSerializerContext.Default.GraphQLResponseReadTextFileWithVersionData);
    return result?.Data ?? throw new InvalidOperationException("Received null data for request ReadTextFileWithVersion.");
}public static TestData Test(List<AdditionalFileInput> graphql)
{
    ...
    var response = Imports.GraphQL(request, GraphQLClientJsonSerializerContext.Default.GraphQLRequestTestVariables);
    var result = JsonSerializer.Deserialize<GraphQLResponse<TestData>>(response, GraphQLClientJsonSerializerContext.Default.GraphQLResponseTestData);
    return result?.Data ?? throw new InvalidOperationException("Received null data for request Test.");
}
}
...
CamelCase,[EnumMember(Value = "SnakeCase")]
SnakeCase,[EnumMember(Value = "UpperSnakeCase")]
UpperSnakeCase,[EnumMember(Value = "LowerSnakeCase")]
LowerSnakeCase,[EnumMember(Value = "KebabCase")]
KebabCase,[EnumMember(Value = "UpperKebabCase")]
UpperKebabCase,[EnumMember(Value = "LowerKebabCase")]
LowerKebabCase,[EnumMember(Value = "LowerCase")]
LowerCase,[EnumMember(Value = "UpperCase")]
UpperCase,
}
...
CSHARP,[EnumMember(Value = "RUST")]
RUST,[EnumMember(Value = "TYPESCRIPT")]
TYPESCRIPT,[EnumMember(Value = "GO")]
GO,[EnumMember(Value = "KOTLIN")]
KOTLIN,
}
...
GENERATED,[EnumMember(Value = "HEAD")]
HEAD,
}
...
QUERY,[EnumMember(Value = "MUTATION")]
MUTATION,[EnumMember(Value = "SUBSCRIPTION")]
SUBSCRIPTION,
}
...
TRACE,[EnumMember(Value = "DEBUG")]
DEBUG,[EnumMember(Value = "INFORMATION")]
INFORMATION,[EnumMember(Value = "WARNING")]
WARNING,[EnumMember(Value = "ERROR")]
ERROR,[EnumMember(Value = "CRITICAL")]
CRITICAL,
}
...
[JsonPolymorphic]
[JsonDerivedType(typeof(TestFragmentDenestedSelectionSelectionGraphQLFieldSelection, "GraphQLFieldSelection"))]
[JsonDerivedType(typeof(TestFragmentDenestedSelectionSelectionGraphQLFragmentSpreadSelection, "GraphQLFragmentSpreadSelection"))]
[JsonDerivedType(typeof(TestFragmentDenestedSelectionSelectionGraphQLInlineFragmentSelection, "GraphQLInlineFragmentSelection"))]
...
public partial class TestFragmentDenestedSelectionSelectionGraphQLFieldSelection : ITestFragmentDenestedSelectionSelection
{
...
public partial class TestFragmentDenestedSelectionSelectionGraphQLFragmentSpreadSelection : ITestFragmentDenestedSelectionSelection
{
...
public partial class TestFragmentDenestedSelectionSelectionGraphQLInlineFragmentSelection : ITestFragmentDenestedSelectionSelection
{
...
[JsonPolymorphic]
[JsonDerivedType(typeof(TestOperationDenestedSelectionSelectionGraphQLFieldSelection, "GraphQLFieldSelection"))]
[JsonDerivedType(typeof(TestOperationDenestedSelectionSelectionGraphQLFragmentSpreadSelection, "GraphQLFragmentSpreadSelection"))]
[JsonDerivedType(typeof(TestOperationDenestedSelectionSelectionGraphQLInlineFragmentSelection, "GraphQLInlineFragmentSelection"))]
...
public partial class TestOperationDenestedSelectionSelectionGraphQLFieldSelection : ITestOperationDenestedSelectionSelection
{
...
public partial class TestOperationDenestedSelectionSelectionGraphQLFragmentSpreadSelection : ITestOperationDenestedSelectionSelection
{
...
public partial class TestOperationDenestedSelectionSelectionGraphQLInlineFragmentSelection : ITestOperationDenestedSelectionSelection
{
