...
public class TypescriptBot : IMiniBot
{
    public void Execute()
    {
        ...
        GraphQLOperations.AddFile($"{configuration.OutputPath}/esbuild.js",
            """
        ...
        GraphQLOperations.AddFile($"{configuration.OutputPath}/package.json",
            $$"""
              {
        ...
        GraphQLOperations.AddFile($"{configuration.OutputPath}/ExampleMiniBot.cs",
            $$""""
              ...
              """");
        GraphQLOperations.AddFile($"{configuration.OutputPath}/index.d.ts",
            $$""""
              declare module 'main' {
